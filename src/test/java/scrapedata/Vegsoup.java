...
public class Vegsoup extends Baseclass {
	...
	private List<String> IngredientFilter() {
		...
		public void receipesHT() throws InterruptedException, IOException  {
			...
			WebElement vegsoup  = driver.findElement(By.xpath("//a[@id='ctl00_cntleftpanel_ttlhealthtree_tvTtlHealtht161']"));
			vegsoup.click();
			...
			String path =".\\sheets\\vegsoup.xlsx";
